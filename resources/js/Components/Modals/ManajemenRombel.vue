		...
		methods: {
			...
			async nonaktifkan() {
                ...
                if ( await this.$refs.confirm.open("Confirm", "Yakin Me-nonaktifkan siswa terpilih?")) {
                    axios({
                        method: 'put',
                        url: '/dashboard/siswa/nonaktifkan',
			...
			masukkan(){
				...
				axios({
					method: 'post',
					url: '/dashboard/rombel/masukkan?id='+rombel_id,
			...
			keluarkan() {
				...
				axios({
					method: 'post',
					url: '/dashboard/rombel/keluarkan?id='+rombel_id,
			...
			getNonMembers(periode) {
				...
				axios({
					method: 'post',
					url: '/dashboard/siswa/nonmembers?periode='+periode
				}).then( response => {
					// console.log(response)
