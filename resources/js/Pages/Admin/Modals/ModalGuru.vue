	   					...
	   					<v-row>
	   						<v-col cols="3">
	   							...
	   							<v-avatar size="150" class="m-auto">
	   								<img :src="fotoGuru" @error="seDefaultFoto" />
	   							</v-avatar>
	   						...
	   						<v-col cols="9">
			   					<v-row>
			   						...
			   						<v-col cols="12" sm="6">
			   							<v-autocomplete v-model="newguru.role" outlined rounded label="Role" dense hide-details :items="roles" item-text="text" item-value="value"></v-autocomplete>
			   						</v-col>
			   						<v-col cols="12" sm="6">
			   						...
			   						<v-col cols="12" sm="9">
			   							<v-textarea v-model="newguru.alamat" outlined rounded label="Alamat" rows="1"  auto-grow dense hide-details />
			   						</v-col>
	...
	export default {
		...
		data: () => ({
			...
			roles: [
	            ...
	            {value:'gbd', text: 'Guru Agama Budha'},
	            {value:'gkh', text: 'Guru Agama Konghuchu'},
			],
			status: [
				{ text: 'PNS', value: 'pns'},
				{ text: 'GTT', value: 'gtt'},
		...
		methods: {
			...
			seDefaultFoto(e) {
				const jk = this.newguru.jk ? this.newguru.jk : 'l'
				var foto = '/storage/img/users/user_'+jk+'.png'
				e.target.src = foto
			}
		},
		computed: {
			fotoGuru() {
				const nip = this.newguru.nip
				return '/storage/img/users/'+nip+'.jpg'
			}
		},
		mounted() {
