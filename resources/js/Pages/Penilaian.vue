                ...
                <v-col cols="12"> 
                    <v-card>
                        <v-toolbar dense color="secondary">
                            ...
                            <v-spacer/>
                            <v-btn rounded color="primary" @click=" ph = !ph">{{ (ph == true) ? 'Sembunyikan' : 'Lihat' }}</v-btn>
                        </v-toolbar>
                        <v-expand-transition>
                                            ...
                                            <v-card-text >
                                                ...
                                                <v-list dense style="background: transparent!important;">
                                                    ...
                                                    <v-list-item-group v-if="item.value=='pabp' || ($page.props.mapel && $page.props.mapel.kode_mapel == 'pabp') " class="my-2 elevation-3" rounded>
                                                        <v-list-item :style="bg(item.nh1.prosentase, item.nh1.jml_kd)" @click="showModalNilai(item, 'uh', null, 'k1')" :dark="(item.nh1.prosentase > 80) ? true:false">
                                                            <v-list-item-content>
                                                                <v-list-item-title>K-1:SPIRITUAL</v-list-item-title>
                                                            </v-list-item-content>
                                                            <v-list-item-icon>
                                                                <v-icon text>
                                                                    {{ Math.round(item.nh1.prosentase) }}%
                                                                </v-icon>
                                                            </v-list-item-icon>
                                                        </v-list-item>
                                                    </v-list-item-group>
                ...
                <v-col cols="12"> 
                    <v-card>
                        <v-toolbar dense color="secondary">
                            ...
                            <v-spacer/>
                            <v-btn rounded color="primary" @click=" pts = !pts">{{ (pts == true) ? 'Sembunyikan' : 'Lihat' }}</v-btn>
                        </v-toolbar>
                        <v-expand-transition>
                ...
                <v-col cols="12"> 
                    <v-card>
                        <v-toolbar dense color="secondary">
                            ...
                            <v-spacer/>
                            <v-btn rounded color="primary" @click=" pas = !pas">{{ (pas == true) ? 'Sembunyikan' : 'Lihat' }}</v-btn>
                        </v-toolbar>
                        <v-expand-transition>
